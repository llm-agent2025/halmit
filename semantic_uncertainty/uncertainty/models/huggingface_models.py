...
class HuggingfaceModel(BaseModel):
    ...
    def __init__(self, model_name, stop_sequences=None, max_new_tokens=None):
        ...
        if 'llama' in model_name.lower():
            ...
            #     token_type_ids=None)
            self.tokenizer = AutoTokenizer.from_pretrained("/mnt/data/liusiyuan/checkpoint/llama2", token_type_ids=None)
            ...
            if ('7b' in model_name or '13b' in model_name) or eightbit:
                ...
                self.model = AutoModelForCausalLM.from_pretrained(
                    "/mnt/data/liusiyuan/checkpoint/llama2", device_map="auto"
                )
