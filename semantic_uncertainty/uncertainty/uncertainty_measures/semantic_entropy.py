...
class EntailmentDeberta(BaseEntailment):
    def __init__(self):
        self.tokenizer = AutoTokenizer.from_pretrained("/mnt/data/liusiyuan/checkpoint/microsoftdeberta-v2-xlarge-mnli")
        self.model = AutoModelForSequenceClassification.from_pretrained(
            "/mnt/data/liusiyuan/checkpoint/microsoftdeberta-v2-xlarge-mnli").to(DEVICE)
